...
$CheckSQL = "SELECT * FROM patcheck WHERE railwaysid='$rwfid' AND dob='$dob'";
...
if(isset($check)){
    ...
    $CheckSQLL = "SELECT * FROM patreg WHERE railwaysid='$rwfid' AND dob='$dob'";
 ...
 $query="insert into patreg(fname,lname,gender,email,contact,password,cpassword,railwaysid,dob) values ('$fname','$lname','$gender','$email','$contact','$password','$cpassword','$rwfid','$dob');";
